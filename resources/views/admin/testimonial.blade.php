...
<div>
    <form class="flex my-3 pr-10" action="{{url('/viewtestimonial')}}" method="get">
      ...
      <table>
        <tr>
          <th style="padding:30px">Title <a href="{{url('/viewtestimonial/name/asc')}}"><i class="fa-solid fa-arrow-up-wide-short"></i></a> <a href="{{url('/viewtestimonial/name/desc')}}"><i class="fa-solid fa-arrow-down-wide-short"></i></a></th>
